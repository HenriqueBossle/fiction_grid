        ...
        @csrf
            <div class="mb-8">
                ...
                <div class="relative">
                    ...
                    <input type="text" name="name" id="name" class="w-full pl-12 pr-4 py-4 rounded-xl border-2 border-indigo-100 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-100 outline-none transition placeholder-indigo-300" placeholder="Ex: Star Wars, Marvel, Harry Potter..."required>
                </div>
            </div>
